...
export default function SearchBar({ onSearch, placeholder, buttonText }) {
  ...
  return (
    <form onSubmit={submit} className="flex gap-3 items-center">
      ...
      <button
        type="submit"
        className="px-4 py-2 bg-gradient-to-r from-sky-500 to-indigo-600 text-white rounded-lg shadow hover:from-sky-600 hover:to-indigo-700 transition-transform transform hover:-translate-y-0.5 active:translate-y-0"
      >
